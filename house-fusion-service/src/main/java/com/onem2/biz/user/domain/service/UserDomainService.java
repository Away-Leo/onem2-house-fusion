...
import com.onem2.biz.user.domain.entity.User;
import com.onem2.biz.user.domain.repository.UserRepository;
...
public class UserDomainService extends BaseDomainService<UserRepository, User, UserDto> {
     ...
     * @Param: userName 用户账号
     * @Return: java.util.List<com.onem2.biz.user.domain.entity.User>
     ...
     * @Description: 创建用户
     * @Param: user 用户
     * @Return: com.onem2.biz.user.domain.entity.SeUser
