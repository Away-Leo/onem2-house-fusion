...
import com.onem2.biz.menu.domain.entity.UserFunctionAuthConf;
...
public interface UserFunctionAuthConfRepository extends BaseRepository<UserFunctionAuthConf,Long> {
     ...
     * @Description: 按照用户查找
     * @Param: userId
     * @Return java.util.List<com.onem2.biz.menu.domain.entity.UserFunctionAuthConf>
     * @Date 2018/2/8 11:53
     * @Copyright 重庆壹平方米网络科技有限公司
     */
     ...
     * @Param: userId
     * @Param: url
     * @Return com.onem2.biz.menu.domain.entity.UserFunctionAuthConf
     * @Date 2018/2/8 11:55
     * @Copyright 重庆壹平方米网络科技有限公司
     */
     ...
     * @Param: pageable
     * @Param: params
     * @Return org.springframework.data.domain.Page<com.onem2.biz.menu.domain.entity.UserFunctionAuthConf>
     * @Date 2018/3/5 14:27
     * @Copyright 重庆壹平方米网络科技有限公司
     */
