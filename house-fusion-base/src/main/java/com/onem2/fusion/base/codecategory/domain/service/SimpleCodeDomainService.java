...
import com.onem2.fusion.base.codecategory.app.dto.SimpleCodeDto;
import com.onem2.fusion.base.codecategory.domain.entity.SimpleCode;
import com.onem2.fusion.base.codecategory.domain.repository.SimpleCodeRepository;
...
public class SimpleCodeDomainService extends BaseDomainService<SimpleCodeRepository,SimpleCode,SimpleCodeDto>{
     ...
     * @Return: java.util.List<com.onem2.fusion.base.codecategory.app.dto.SimpleCodeDto>
     * @Date: 2018/4/24 9:50
     ...
     * @Param: code 唯一编号
     * @Return: com.onem2.fusion.base.codecategory.app.dto.SimpleCodeDto
     * @Date: 2018/4/24 9:58
