package com.onem2.fusion.base.codecategory.domain.repository;
...
public interface SimpleCodeRepository extends BaseRepository<SimpleCode,Long>{
     ...
     * @Return: java.util.List<com.onem2.fusion.base.codecategory.domain.entity.SimpleCode>
     ...
     * @Param: code 唯一编号
     * @Return: com.onem2.fusion.base.codecategory.domain.entity.SimpleCode
