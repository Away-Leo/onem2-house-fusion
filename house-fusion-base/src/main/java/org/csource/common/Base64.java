 ...
 * about 1/3.  The "=" character is used to pad the end.  Base64Utils is used,
 * among other things, to encode the user:password string in an
 * Authorization: header for HTTP.  Don't confuse Base64Utils with
 ...
 * now need Base64Utils object and instance methods.
 * new mailing address.
...
//  }// end main
  ...
  /**
   * Encode an arbitrary array of bytes as Base64Utils printable ASCII.
  ...
  /**
   * decode a well-formed complete Base64Utils string back into an array of bytes.
