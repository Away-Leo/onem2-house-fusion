package com.laman.biz.menu.domain.entity;
...
*/
@Entity
@Table(name="fusion_user_function_conf")
@org.hibernate.annotations.Table(appliesTo = "fusion_user_function_conf",comment = "用户功能权限配置")
@Getter
@Setter
