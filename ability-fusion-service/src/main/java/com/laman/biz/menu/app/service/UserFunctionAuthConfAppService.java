...
import com.laman.biz.menu.domain.service.UserFunctionAuthConfDomainService;
...
public class UserFunctionAuthConfAppService {
     ...
     * @Param: pageable
     * @Param: params
     * @Return org.springframework.data.domain.Page<com.laman.biz.menu.app.dto.UserFunctionAuthConfDto>
     * @Date 2018/3/5 14:31
     * @Copyright 重庆拉曼科技有限公司
     */
