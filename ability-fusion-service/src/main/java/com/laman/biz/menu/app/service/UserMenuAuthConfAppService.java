...
import com.laman.biz.menu.app.dto.UserMenuAuthConfDto;
import com.laman.biz.menu.domain.service.UserMenuAuthConfDomainService;
...
public class UserMenuAuthConfAppService {
     ...
     * @Param:
     * @Return java.util.List<com.laman.biz.menu.app.dto.UserMenuAuthConfDto>
     * @Date 2018/2/8 16:20
     * @Copyright 重庆拉曼科技有限公司
     */
     ...
     * @Param: userId
     * @Param: menuId
     * @Return com.laman.biz.menu.domain.entity.UserMenuAuthConf
     * @Date 2018/3/2 18:07
     * @Copyright 重庆拉曼科技有限公司
     */
